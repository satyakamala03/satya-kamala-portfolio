...
export const experiences: ExperienceItem[] = [
  {
    ...
    starDetails: [
      {
        situation: 'It is natural that students tend to have questions regarding the concepts, homeworks and projects even after the lecture completes. Sometimes they need additional handholding to finish the tasks using the right methods.',
        ...
        action: 'I conduct regular office hours where I break down complex concepts into digestible explanations. I use real world examples and interactive demonstrations to illustrate design patterns. I also provide one-on-one support for students working on projects and assignments, tailoring my explanations to their learning styles.',
        result: 'Students show improved understanding of concepts, with better assignment submissions and more confident participation in class discussions.',
      },
      {
        situation: 'Students needed additional support outside of regular class hours to complete assignments and projects.',
        ...
        action: 'I schedule regular office hours and conduct structured lab sessions focused on hands-on work. I prepare supplementary materials and examples to reinforce concepts taught in class. I actively engage with students to identify knowledge gaps and address them promptly.',
        result: 'Students report feeling more confident about their work.',
      },
      {
        situation: 'Grading needed to be consistent and provide meaningful feedback to help students improve their work and correlating it with HCI principles.',
        task: 'Grade assignments fairly and provide constructive, actionable feedback that helps students grow in their skills.',
        ...
        result: 'Students receive consistent, valuable feedback that helps them understand their performance and improve future work.',
      },
    ],
  },
  {
